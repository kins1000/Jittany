...
export default function Scoreboard({ teams }) {
    ...
    const teamsWithScores = teams.map((team) => ({
        ...team,
        totalScore: getTeamTotal(team.id),
    }));
        ...
        <div className="space-y-4">
            <div className="flex items-center gap-3 mb-6">
                ...
                <Link to="/pointsdetail">
                    <h2 className="text-2xl font-display font-bold hover:text-primary transition-colors cursor-pointer">
                        Scoreboard
                    </h2>
                </Link>
            </div>
                ...
                {sorted.map((team, index) => (
                    ...
                    >
                        <div
                            ...
                            style={{
                                width: `${(team.totalScore / maxScore) * 100}%`,
                                backgroundColor:
